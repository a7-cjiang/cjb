...
public class MessageUtils {
    public static String sendMsg(String phoneNum){
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI4G1ZsneNzhy8gsmp2JaJ", "juxC0WB7J2jv52bc0JkR0OhiwtGsDQ");
        ...
        request.putQueryParameter("SignName", "宁哥商城");
        Map map=new HashMap();
